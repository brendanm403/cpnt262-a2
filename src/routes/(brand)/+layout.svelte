<script>
	...
	// gets me access to the location object //
	...
	// required for app rail //
	let currentTile = 0;
	
	// default icons for home and about layout //
	...
	// changes the icons when about route accessed //
	...
	// if  About page is refreshed the icons will remain correct thanks to this function //
	if (browser) {
		...
		// call function to keep icons the same if refresh button clicked, not an issue with the home route becuase home layout uses the icons in the global array called accordian icons. If I refreshed the page on the about route it would reset them to the accordian array default icons and this fixes that problem //
